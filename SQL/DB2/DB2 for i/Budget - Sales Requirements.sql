...
SELECT 
	...
	V6OPTR RUNSIZE, 
	AOSCRW SETCREW, 
	CASE AASTDR WHEN 0 THEN ABLABR ELSE AASTDR END LABRATE, 
	...
	CASE WHEN AAOSRV = 'Y' 
		...
		ELSE 
			...
			/ AORUNS 
	END VARRUN, 
	CASE AASTDR WHEN 0 THEN ABLABR ELSE AASTDR END * AOSETP * AOSCRW / V6OPTR LABSET, 
	...
	APUNCS * ERQTY SUBCX, 
	CASE WHEN AAOSRV = 'Y' THEN 0 ELSE CASE AASTDR WHEN 0 THEN ABLABR ELSE AASTDR END / AORUNS * AO#MEN / AO#MCH * ERQTY  END LABRX, 
	...
	CASE AASTDR WHEN 0 THEN ABLABR ELSE AASTDR END * AOSETP * AOSCRW / V6OPTR * ERQTY LABSX, 
	...
	CASE WHEN AAOSRV = 'Y' THEN 0 ELSE CASE AASTDR WHEN 0 THEN ABLABR ELSE AASTDR END / AORUNS * AO#MEN / AO#MCH * ERQTY * (1 / XREFF - 1) END LABRXS, 
	...
	CASE AASTDR WHEN 0 THEN ABLABR ELSE AASTDR END * AOSETP * AOSCRW / V6OPTR * ERQTY * (1 / XREFF - 1) LABSXS, 
